                    		...
                    		<div class="take_quiz">
                    			<div class="row">
                    				<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                    					<h4>Student Name: <?php echo (sizeof($quiz_results) > 0) ? $quiz_results['stdName'] : "NONE"; ?></h4>
                    					<strong>Student #: <?php echo (sizeof($quiz_results) > 0) ? $quiz_results['stdNum'] : "NONE"; ?></strong><br/>
                    					<strong>
		                    				<?php
		                    					if ($quiz_data != NULL){
